...
| Diluted shares | 948.675m | History | FY2025 reported weighted-average diluted shares. A current fully diluted Q2 2026 count is **UNRESOLVED**; the Q2 942.134m figure is basic shares outstanding and is not used as diluted shares. |
...
| FY2025 diluted weighted-average shares | 948.675m |
| **Implied value per share** | **$181.15** |
...
The model indicates approximately **$181.15 per share**, compared with IBM's market price of approximately **$227.66 as of September 24, 2026 at 2:48 PM Eastern**.
...
## 11. Partner Attack and Response

This is a red-team/partner-review section prepared for the lab; it does not represent comments from an identified classmate.

| Attack | Response |
| --- | --- |
| “Your margin expansion is unsupported.” | Correctly partly true: the model labels margin expansion as Judgment, not guidance. IBM supports operating pre-tax-margin improvement and productivity, but not a multi-year GAAP gross-margin target. |
| “IBM Financing should not be treated like normal working capital.” | Addressed: the rebuilt model separates Financing receivables and links Financing debt to them; the remaining receivables path is still a Judgment to test. |
| “The valuation ignores Confluent.” | Addressed: FY2026 includes the Q2-reported $10.480bn acquisition cash use and acquired intangibles. Future acquisitions remain a Judgment of zero and should be monitored. |
| “Terminal value dominates.” | Valid: PV of terminal value is about 77% of total equity value, so cost of equity and terminal growth deserve sensitivity analysis before relying on $181.15. |
...
- [IBM Q2 2026 Form 10-Q](https://www.sec.gov/Archives/edgar/data/51143/000005114326000078/ibm-20260630.htm): current balance sheet, basic shares outstanding, Confluent cash use, debt, and segment performance.
